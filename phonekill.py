...
for le in la:
	...
	print(le,end="")
time.sleep(0.1)
if a=="kareem" or a=="kareem" or a=="kareem" or a=="kareem" or a=="a" or a=="":
	os.system("clear")
	...
	def new():
		os.system("clear")
		os.system("figlet kareem alshafey")
		print(yellow+bold+"\t\t\tv 1.1.2")
		print("")
		print(green+"-"*50)
	...
	def us():
		...
		if take=="1":
			...
			time.sleep(3)
			os.system("clear")
			os.system("figlet KAreemAlshafey")
			print(yellow+bold+"\t\t\tv 1.1.2")
			print("\n")
			print(green+"\t\t\tLoading…")
			print(cyan+"\t\t\t██████████100%")
			...
			print(cyan+"\t\tWAIT FOR NEXT UPDATE /or/ call me:+201068960354")
		elif take=="4":
	...
	print("\t\tTry Again Bro Wrong Password!🥺🥺!!////// call 01068960354")